                ...
                <div style={{display:this.props.state.isStarted?"":"none"}} className="question-box">
                    <form onSubmit={this.handleNextClick}>
                        ...
                        <div className="action">
                            <div>
                            <button style={{display:this.props.state.questions.length<5?"":"none",backgroundColor:"rgba(0,0,0,0.5)"}} onClick={this.handleSkipClick}>Skip & Next</button>
                            </div>
                            <div>
                            <button type="submit" style={{display:this.props.state.questions.length<5?"":"none",backgroundColor:"#089673"}}>Save & Next</button>
                            <button style={{display:this.props.state.questions.length<5?"none":"", backgroundColor:"#089673"}} onClick={this.handleFinishClick}>Finish</button>
                            </div>
                        </div>
